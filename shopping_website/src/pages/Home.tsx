        ...
        <section className={styles.homebox} role="region" aria-label="Introduction and Shop Promotion">
          <article className={styles.informationbox} role="article" aria-label="Store Information">
            ...
            <p className={styles.informationtext}>
              Experience premium clothing, jewelry, and electronics made from authentic materials. Choose us for
              timeless fashion and exceptional craftsmanship.
            </p>
            <Link className={styles.link} to="/Shopping">
              <button className={styles.shoppingbutton} onClick={() => "/Shopping"} aria-label="Explore our products">
