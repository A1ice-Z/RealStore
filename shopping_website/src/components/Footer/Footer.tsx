            ...
            <section className={styles.imageholder} aria-label="Footer Promotional Section">
                ...
                <div className={styles.box} role="region" aria-label="Footer Navigation">
                    <div className={styles.informationbox}>
                        ...
                        <div>
                            <p className={styles.informationtitle} aria-label="Products Section">PRODUCTS</p>
                            <Link to={"/"} className={styles.informationlink}>
                                <p className={styles.informationtext} aria-label="Electronics Link">Electronics</p>
                            </Link>
                            <Link to={"/"} className={styles.informationlink}>
                                <p className={styles.informationtext} aria-label="Women's Fashion Link">Women's Fashion</p>
                            </Link>
                            <Link to={"/"} className={styles.informationlink}>
                                <p className={styles.informationtext} aria-label="Men's Fashion Link">Men's Fashion</p>
                            </Link>
                            <Link to={"/"} className={styles.informationlink}>
                                <p className={styles.informationtext} aria-label="Jewelry Link">Jewelry</p>
                            </Link>
                        </div>
                    </div>
